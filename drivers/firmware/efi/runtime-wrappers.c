 ...
 * arguments.
 */
static void __efi_realign_stack __nocfi efi_call_rts(struct work_struct *work)
{
...
static efi_status_t __efi_realign_stack __nocfi
...
static void __efi_realign_stack __nocfi
